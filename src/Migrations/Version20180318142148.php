 ...
 */
class Version20180318142148 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE cathegory_id category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE category_id cathegory_id INT DEFAULT NULL');
